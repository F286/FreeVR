...
struct  ClientRpcAttribute_t4239051851  : public Attribute_t498693649
{
public:
...
public:
	inline static int32_t get_offset_of_channel_0() { return static_cast<int32_t>(offsetof(ClientRpcAttribute_t4239051851, ___channel_0)); }
